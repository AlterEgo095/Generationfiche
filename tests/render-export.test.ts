...
function makeSections(): SectionContent[] {
  const contenus: Record<string, string> = {
    objectifs: "À l'issue de la séquence, l'élève sera capable de calculer une longueur dans un triangle rectangle en utilisant le théorème de Pythagore. L'élève saura également vérifier si un triangle est rectangle ou non à partir des longueurs de ses côtés. L'élève mobilisera le théorème dans des problèmes concrets de la vie courante et développera une démarche scientifique rigoureuse.",
    prerequis: "L'élève doit maîtriser : le carré d'un nombre entier ou décimal, la racine carrée d'un nombre positif, la propriété de la somme des angles dans un triangle, la reconnaissance d'un triangle rectangle par la présence d'un angle droit. Ces prérequis sont essentiels pour aborder le théorème de Pythagore dans de bonnes conditions.",
    deroulement: "1. Activation des prérequis (10 min) : rappel sur le carré d'un nombre et la racine carrée. Exercices rapides de calcul mental pour vérifier les acquis. 2. Activité d'introduction avec la corde à 13 nœuds (15 min) : découverte du théorème par manipulation. Les élèves forment des triangles et mesurent les côtés pour conjecturer la relation BC² = AB² + AC². 3. Institutionnalisation (15 min) : énoncé formel du théorème de Pythagore, démonstration géométrique par découpage, exemples d'application au tableau. 4. Exercices d'application différenciés (10 min) : calculs directs de l'hypoténuse, puis calcul d'un côté de l'angle droit, et enfin problème concret avec une échelle contre un mur.",
    activites: "Activité 1 : corde à 13 nœuds pour construire un triangle rectangle de côtés 3-4-5. Les élèves mesurent et vérifient que 3² + 4² = 5². Activité 2 : mesure des côtés de plusieurs triangles rectangles et conjecture sur la relation BC² = AB² + AC². Mise en commun et formulation du théorème. Activité 3 : exercices d'application gradués — calcul de l'hypoténuse, puis d'un côté de l'angle droit, enfin problème concret avec une échelle appuyée contre un mur de 4 m de haut. Activité 4 : vérification de la nature d'un triangle à partir de ses trois côtés.",
    differentiation: "Groupes de besoin : atelier dirigé avec l'enseignant pour les élèves fragiles (calcul guidé étape par étape, support visuel avec triangles colorés). Tâche complexe pour les élèves avancés (problème concret avec étapes multiples : calcul de la diagonale d'un rectangle puis d'un pavé droit). Fiche outil avec formule et étapes pour tous. Tutorat entre pairs pour les exercices intermédiaires.",
    evaluation: "4 questions : 1 calcul direct de l'hypoténuse (BC dans un triangle ABC rectangle en A avec AB=3 et AC=4), 1 calcul d'un côté de l'angle droit (AB avec BC=10 et AC=6), 1 problème concret (échelle de 5 m contre un mur, à quelle distance du pied du mur), 1 démonstration (vérifier si un triangle de côtés 5, 12, 13 est rectangle). Critère de réussite : 3/4 questions justes avec démarche visible.",
    prolongement: "Lien avec le théorème de Thalès (séquence suivante dans la progression). Application en topographie : mesure de distances inaccessibles. Histoire des mathématiques : le théorème de Pythagore dans différentes civilisations (Babylone, Chine, Inde). Ouverture vers la réciproque du théorème.",
  }
